...
import com.udacity.krishna.newsapp.ui.ArticleBaseActivity;
import com.udacity.krishna.newsapp.widget.NewsWidget;
    ...
    public List<Article> insertAll(Article[] articles, int type) {
        ...
        for (Article article : articles) {
            try {
                ...
                e.printStackTrace();
                Tracker t = ((CoffeeTime) context).getDefaultTracker();
