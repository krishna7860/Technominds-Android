...
public abstract class ArticleBaseActivity extends AppCompatActivity {
    public static final String EVENT_LOADING = "com.udacity.krishna.newsapp.EVENT_LOADING";
    public static final String EVENT_LOAD_FINISHED = "com.udacity.krishna.newsapp.EVENT_LOAD_FINISHED";
    public static final String EVENT_LOAD_FAILED = "com.udacity.krishna.newsapp.EVENT_LOAD_FAILED";
    public static final String EVENT_LOAD_EMPTY = "com.udacity.krishna.newsapp.EVENT_LOAD_EMPTY";
